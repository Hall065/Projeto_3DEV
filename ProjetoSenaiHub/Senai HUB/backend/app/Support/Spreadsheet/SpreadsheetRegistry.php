        ...
        return [
            ...
            'students' => self::def(
                ...
                [
                    ...
                    ['key' => 'data_nascimento', 'header' => 'data_nascimento', 'example' => '2006-05-12'],
                    ['key' => 'status', 'header' => 'status', 'example' => 'active'],
                    ['key' => 'codigo_turma', 'header' => 'codigo_turma', 'example' => 'TURMA AUT25-02'],
                ],
            ),
            'teachers' => self::def(
                'Professores',
            ...
            'courses' => self::def(
                ...
                [
                    ['key' => 'codigo', 'header' => 'codigo', 'required' => true, 'example' => 'AUT-IMP'],
            ...
            'classes' => self::def(
                ...
                [
                    ['key' => 'codigo', 'header' => 'codigo', 'required' => true, 'example' => 'TURMA AUT25-02'],
                    ['key' => 'nome', 'header' => 'nome', 'required' => true, 'example' => 'Turma Automacao 2025'],
                    ['key' => 'codigo_curso', 'header' => 'codigo_curso', 'example' => 'AUT'],
                    ['key' => 'email_professor', 'header' => 'email_professor', 'example' => 'carlos.professor@senai.local'],
            ...
            'contracts' => self::def(
                ...
                [
                    ['key' => 'matricula_aluno', 'header' => 'matricula_aluno', 'required' => true, 'example' => '2025AUT0003'],
            ...
            'attendance' => self::def(
                ...
                [
                    ['key' => 'codigo_turma', 'header' => 'codigo_turma', 'required' => true, 'example' => 'TURMA AUT25-02'],
                    ['key' => 'data_sessao', 'header' => 'data_sessao', 'required' => true, 'example' => '2026-06-14'],
        ...
        return [
            'users' => self::def(
                ...
                [
                    ...
                    ['key' => 'perfil', 'header' => 'perfil', 'required' => true, 'example' => 'Tecnico de manutencao'],
            ...
            'tasks' => self::def(
                ...
                [
                    ['key' => 'codigo_chamado', 'header' => 'codigo_chamado', 'example' => '#CH-2026-S01'],
