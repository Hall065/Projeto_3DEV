...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="min-h-screen bg-zinc-50 text-zinc-900">
        <flux:sidebar sticky collapsible="mobile" class="border-e border-zinc-200 bg-white">
            ...
            <flux:sidebar.nav>
                <flux:sidebar.group heading="Geral" class="grid">
                ...
                <flux:sidebar.group heading="Módulos" class="grid">
                    ...
                    <flux:sidebar.item icon="book-open-text" :href="route('relatorios.index')" :current="request()->routeIs('relatorios.*')" wire:navigate>
                        Relatórios
                    </flux:sidebar.item>
                </flux:sidebar.group>
            </flux:sidebar.nav>
